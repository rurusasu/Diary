...
その後、再起動すると画像のような `Enroll MOK` というものが表示されていることに気づいた. そこで、調べてみたところ[Ubuntu に NVIDIA のドライバをインストール （Enroll MOK に注意）](https://qiita.com/junkoda/items/0c58e0c996b56b773d50) という記事をみつけた. この記事によると
